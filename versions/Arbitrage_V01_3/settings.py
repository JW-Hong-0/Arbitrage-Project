...
STRATEGY_PRESETS = {
    "major": { 
        "entry_threshold_pct": 0.05,  # 메이저 코인은 0.1%도 큼. 0.2%로 상향 추천
        "exit_threshold_pct": 0.01 
    },
    "alt": { 
        "entry_threshold_pct": 0.1,  # 0.3 -> 0.4 상향 추천
        "exit_threshold_pct": 0.05 
    },
    "volatile": { 
        "entry_threshold_pct": 0.3,  # 사용자님 제안 (Good!)
        "exit_threshold_pct": 0.05 
    },
    "pre_market": { 
